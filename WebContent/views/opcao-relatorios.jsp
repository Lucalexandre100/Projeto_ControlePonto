...
<head>
  ...
  <title>Opção Relatórios | Controle de Ponto</title>
  <!-- Favicon -->
      ...
      <div class="container">
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            ...
            <p class="text-lead text-light">Os relatórios exportados serão salvos no diretório: "C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/ControlePonto - Reports/"</p>
              <p class="text-lead text-light">Escolha uma ação...</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-6 col-md-8">
            <div class="card-body px-lg-5 py-lg-5">
				...
				<form method="post" action="../relatorios.do">
					<button class="btn btn-primary mt-4" type="submit" name="expFunc" value="1">Exportar funcionários</button>
				</form>
				<%
