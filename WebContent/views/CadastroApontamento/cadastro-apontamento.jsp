...
<head>
  ...
  <title>Cadastro Apontamento | Controle de Ponto</title>
  <!-- Favicon -->
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6">
              ...
              <p class="text-lead text-light">Cadastro de Apontamento de Horas</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-6 col-md-8">
            <div class="card-body px-lg-5 py-lg-5">
              <form role="form" action="../../CadastroApontamento.do" method="post">
                ...
                <div class="form-group">
                  <div class="input-group input-group-alternative mb-3">
                    ...
                    <input class="form-control" name="dataCad" placeholder="Data de Cadastro" type="date">
                  </div>
                </div>
				<div class="form-group">
                  ...
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" name="hrEntrada" placeholder="Hora Entrada" type="time">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="input-group input-group-alternative">
					...
					<input class="form-control" name="hrSaidaAlmoco" placeholder="Hora Saída Almoço" type="time">
                  </div>
                </div>
				<div class="form-group">
					<label>Hora Volta Almoço</label>
                  <div class="input-group input-group-alternative">
                    <div class="input-group-prepend">
                      <span class="input-group-text"><i class="ni ni-time-alarm"></i></span>
                    </div>
                    <input class="form-control" name="hrVoltaAlmoco" placeholder="Hora Volta Almoço" type="time">
                  </div>
                </div>
				<div class="form-group">
                  ...
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" name="hrSaida" placeholder="Hora Saída" type="time">
                  </div>
                </div>
                <div class="text-center">
                  <input type="submit" class="btn btn-primary mt-4" value="Cadastrar apontamento">
                </div>
              </form>
            </div>
          </div>
